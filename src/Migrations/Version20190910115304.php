 ...
 */
final class Version20190910115304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE episode (id INT AUTO_INCREMENT NOT NULL, season_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, number INT NOT NULL, runtime INT NOT NULL, summary LONGTEXT NOT NULL, airstamp DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_DDAA1CDA4EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, tv_show_id INT DEFAULT NULL, number INT NOT NULL, poster VARCHAR(255) DEFAULT NULL, episode_count INT NOT NULL, premiere_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, INDEX IDX_F0E45BA95E3A35BB (tv_show_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tvshow (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, network_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, status INT NOT NULL, poster VARCHAR(255) NOT NULL, website VARCHAR(255) DEFAULT NULL, rating INT NOT NULL, language VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, runtime INT NOT NULL, id_tvmaze INT NOT NULL, id_imdb INT DEFAULT NULL, created_at DATETIME NOT NULL, upadted_at DATETIME DEFAULT NULL, api_update DATETIME DEFAULT NULL, id_tvdb INT NOT NULL, INDEX IDX_44A9FD06C54C8C93 (type_id), INDEX IDX_44A9FD0634128B91 (network_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
