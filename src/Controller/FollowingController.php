...
class FollowingController extends AbstractController
{
     ...
     */
    public function new($id, $status, $showId, $seasonNumber, $episodeNumber, UserRepository $userRepository, ShowRepository $showRepository, FollowingRepository $followingRepository, TypeRepository $typeRepository, GenreRepository $genreRepository, NetworkRepository $networkRepository, EntityManagerInterface $em)
    {
